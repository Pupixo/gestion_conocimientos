...
import { IconCloudUploadComponent } from './icon-cloud-upload';
import { IconAddFolderComponent } from './icon-add-folder';
import { IconAddFileComponent } from './icon-add-file';
import { IconWatchTimeComponent } from './icon-watch-time';
...
@NgModule({
    ...
    declarations: [
        ...
        IconAddFileComponent,
        IconWatchTimeComponent,
        IconCodeComponent,
        IconCoffeeComponent,
        IconCopyComponent,
